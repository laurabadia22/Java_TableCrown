...
<#-- Blocco filtri personalizzato per la categoria Giochi -->
<#macro filtriGiochiExtra>
...
<#-- Rendering della pagina tramite la macro condivisa -->
...
extraFiltriMacro=filtriGiochiExtra />