            ...
            <div class="navbar-row-top-clean">
                ...
                <div id="navbar-menu-custom" class="navbar-menu-custom-links">
                    ...
                    <div class="navbar-center-links">
                        ...
                        <#-- MENU AREA GESTORE -->
                        <#if current_page?? && current_page?starts_with("gestore_")>
                            <a class="navbar-item<#if current_page == 'gestore_dashboard'> is-active</#if>" href="${base_url}/gestore/dashboard">Dashboard</a>

                            <div class="has-catalogo-dropdown" id="catalogo-dropdown">
                                <span class="navbar-item catalogo-label<#if current_page?contains('catalogo')> is-active</#if>">
                                    Gestisci Catalogo
                                    <i class="ti ti-chevron-down navbar-dropdown-arrow"></i>
                                </span>
                                <div class="navbar-dropdown-catalogo">
                                    <a class="navbar-item<#if current_page == 'gestore_catalogo_giochi'> is-active</#if>" href="${base_url}/gestore/catalogo/giochi-da-tavolo">
                                        <i class="ti ti-dice-5"></i> Giochi da tavolo
                                    </a>
                                    <a class="navbar-item<#if current_page == 'gestore_catalogo_bustine'> is-active</#if>" href="${base_url}/gestore/catalogo/bustine">
                                        <i class="ti ti-cards"></i> Bustine
                                    </a>
                                    <a class="navbar-item<#if current_page == 'gestore_catalogo_portadadi'> is-active</#if>" href="${base_url}/gestore/catalogo/porta-dadi">
                                        <i class="ti ti-package"></i> Porta dadi
                                    </a>
                                </div>
                            </div>

                        <#-- MENU UTENTI STANDARD -->
                        <#else>
                            <div class="has-catalogo-dropdown" id="catalogo-dropdown">
                    ...
                    <div class="navbar-end-actions">
                        ...
                        <#if utente??>
                            <div class="navbar-item has-dropdown" id="user-dropdown">
                                ...
                                <div class="navbar-dropdown is-right">
                                    <#-- Se è il gestore, mostriamo solo il logout -->
                                    <#if current_page?? && current_page?starts_with("gestore_")>
                                        <a class="navbar-item navbar-logout" href="${base_url}/logout"><i class="ti ti-logout"></i> Esci da Gestore</a>
                                    <#-- Se è un utente normale, mostriamo il menu completo -->
                                    <#else>
                        ...
                        <!-- Wishlist e Carrello (NASCOSTI SE SIAMO NELL'AREA GESTORE) -->
                        <#if !(current_page?? && current_page?starts_with("gestore_"))>
