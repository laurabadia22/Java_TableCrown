...
public class CProfilo extends BaseController {
    ...
    public void mostraHub(HttpServletRequest request, HttpServletResponse response, EntityManager em)
        ...
        datiHub.put("immagineUtente", utente.getImgPersona() != null ? Base64.getEncoder().encodeToString(utente.getImgPersona()) : null);
    ...
    public void mostraAccount(HttpServletRequest request, HttpServletResponse response, EntityManager em)
        ...
        request.setAttribute("immagineUtente", utente.getImgPersona() != null ? Base64.getEncoder().encodeToString(utente.getImgPersona()) : null);
    ...
    public void aggiornaAccount(HttpServletRequest request, HttpServletResponse response, EntityManager em)
        ...
        try {
            ...
            Part imgPart = estraiPart(request, "img_profilo"); //TODO: SISTEMARE GESTIONE IMMAGINI (ANCHE SOPRA)
            byte[] nuovaImmagine = estraiImmagine(imgPart);
